...
public class DMPActivity extends Activity {
    ...
    Button.OnClickListener listener_r = new Button.OnClickListener() {
        public void onClick(View v) {
            ...
            Toast myToast = Toast.makeText(DMPActivity.this, "Characteristic read",Toast.LENGTH_LONG);
            myToast.show() ;
            if (mGattCharacteristics != null) {
                final BluetoothGattCharacteristic characteristic =
        ...
        public void onClick(View v) {
            ...
            if (mGattCharacteristics != null) {
                ...
                if ((charaProp | BluetoothGattCharacteristic.PROPERTY_WRITE) > 0) {
                    ...
                    Toast myToast = Toast.makeText(DMPActivity.this, "Characteristic write" + mBluetoothLeService.byteArrayToString(cmd),Toast.LENGTH_LONG);
                    myToast.show() ;
    ...
    Button.OnClickListener listener_n = new Button.OnClickListener() {
        public void onClick(View v) {
            ...
            Toast myToast = Toast.makeText(DMPActivity.this, "Characteristic noticfy",Toast.LENGTH_LONG);
            myToast.show() ;
        }
    };

    Button.OnClickListener listener_brower = new Button.OnClickListener() {
        public void onClick(View v) {
            mButton_brower.setBackgroundColor(0xFF0000FF);

            Toast myToast = Toast.makeText(DMPActivity.this, "Characteristic brower",Toast.LENGTH_LONG);
            myToast.show() ;
